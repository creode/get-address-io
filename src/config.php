...
/**
 * Get Address IO config.php
 *
 * This file exists only as a template for the Get Address IO settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'get-address-io.php'
